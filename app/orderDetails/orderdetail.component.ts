...
export class OrderdetailComponent {
    ...
    getSelectedStitcher(elem) {
        this.StitcherId = elem;
        console.log(elem);
    }

    assignItems(orderItem){
        this._orderService.AssignThisOrderItemToUser(orderItem._id,this.userObject._id,this.StitcherId,this.MasterId).subscribe(a=>{
